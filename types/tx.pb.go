...
var file_tx_proto_rawDesc = []byte{
	...
	0x22, 0x16, 0x0a, 0x14, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x22, 0x2f, 0x0a, 0x14, 0x54, 0x72, 0x61, 0x6e,
	...
	0x0c, 0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x22, 0x2e, 0x0a, 0x14, 0x54, 0x72, 0x61,
	...
	0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xb2, 0x01, 0x0a, 0x12, 0x54, 0x72,
...
var file_tx_proto_depIdxs = []int32{
	...
	0, // 1: gosig.TransactionService.SubmitTransaction:input_type -> gosig.SubmitTransactionReq
	2, // 2: gosig.TransactionService.TransactionStatus:input_type -> gosig.TransactionStatusReq
	1, // 3: gosig.TransactionService.SubmitTransaction:output_type -> gosig.SubmitTransactionRes
	3, // 4: gosig.TransactionService.TransactionStatus:output_type -> gosig.TransactionStatusRes
