...
var file_gosig_proto_rawDesc = []byte{
	...
	0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67, 0x6f, 0x73, 0x69, 0x67, 0x2e, 0x43, 0x65, 0x72, 0x74, 0x69,
	...
	0x70, 0x6f, 0x73, 0x61, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x67, 0x6f,
	0x73, 0x69, 0x67, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61,
	...
	0x2e, 0x67, 0x6f, 0x73, 0x69, 0x67, 0x2e, 0x50, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65, 0x43, 0x65,
	...
	0x32, 0x21, 0x2e, 0x67, 0x6f, 0x73, 0x69, 0x67, 0x2e, 0x54, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69,
	...
	0x32, 0x14, 0x2e, 0x67, 0x6f, 0x73, 0x69, 0x67, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x4d,
	...
	0x64, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67, 0x6f, 0x73, 0x69,
	0x67, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x52, 0x0b, 0x62,
...
var file_gosig_proto_goTypes = []any{
	...
	(*SignedMessage)(nil),              // 5: gosig.SignedMessage
	(*SignedMessages)(nil),             // 6: gosig.SignedMessages
	(*BlockProposal)(nil),              // 7: gosig.BlockProposal
	(*PrepareCertificate)(nil),         // 8: gosig.PrepareCertificate
	(*Prepare)(nil),                    // 9: gosig.Prepare
	(*TentativeCommitCertificate)(nil), // 10: gosig.TentativeCommitCertificate
	(*TentativeCommit)(nil),            // 11: gosig.TentativeCommit
	(*Certificate)(nil),                // 12: gosig.Certificate
}
var file_gosig_proto_depIdxs = []int32{
	...
	12, // 2: gosig.BlockHeader.proposal_cert:type_name -> gosig.Certificate
	7,  // 3: gosig.SignedMessage.proposal:type_name -> gosig.BlockProposal
	8,  // 4: gosig.SignedMessage.prepare:type_name -> gosig.PrepareCertificate
	10, // 5: gosig.SignedMessage.tc:type_name -> gosig.TentativeCommitCertificate
	5,  // 6: gosig.SignedMessages.msgs:type_name -> gosig.SignedMessage
	4,  // 7: gosig.BlockProposal.block_header:type_name -> gosig.BlockHeader
	9,  // 8: gosig.PrepareCertificate.msg:type_name -> gosig.Prepare
	12, // 9: gosig.PrepareCertificate.cert:type_name -> gosig.Certificate
	11, // 10: gosig.TentativeCommitCertificate.msg:type_name -> gosig.TentativeCommit
	12, // 11: gosig.TentativeCommitCertificate.cert:type_name -> gosig.Certificate
